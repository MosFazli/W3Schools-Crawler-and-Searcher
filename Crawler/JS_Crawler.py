...
HostURL = "https://www.w3schools.com/js/{}"
...
def getListUrls():
    URLList = []
    defPage = fetchPage("js_intro.asp")
...
for links in pages:
    ...
    for items in sourceLinkArr:
      ...
      fp = urllib.request.urlopen("https://www.w3schools.com/js/" + links)
      mybytes = fp.read()
      mystr = mybytes.decode("utf8")
      #print(mystr)
      filename = "JS/js{}.html".format(i)
      fname = filename + ".html"
      myString = bytes("https://www.w3schools.com/js/" + links + "\n" + mystr , 'utf-8')
      with open(filename, "wb") as f:
          f.write(myString)
      i += 1
      print("\tSaved", filename)
    if(links == "js_json.asp"):
        break

print("crawl JavaScript section finished")